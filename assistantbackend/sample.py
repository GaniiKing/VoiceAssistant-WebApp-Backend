...
class MyAssistant:
    ...
    def get_india_news(self,category='general'):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    return 'Error extracting news try again later'
    ...
    def preprocess_query(self, sentence_test):
        ...
        youtube_play_sentence="play something on youtube spotify" 
        ...
        test_embedding = self.get_sentence_embedding(sentence=sentence_test)
